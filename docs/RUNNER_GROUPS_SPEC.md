...
### 3.1 Best N เลือกได้
ก๊วนใหญ่เลือกนับ **Best 1 / Best 1-2 / Best 1-2-3** (`Bet.config.bestN` = 1|2|3, default 2) — ใช้กับทีม 3–3, 3–4
อันดับที่ทีมใดทีมหนึ่งคนไม่ถึง → คู่นั้นข้าม (กติกาเดิม) · golden: 3v3 {3,4,5} vs {4,4,6} → Best1 Birdie 2 + Best2 เสมอ + Best3 1 = A +3
