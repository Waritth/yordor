...
> ✅ **ตามที่ก๊วนเล่นจริง (ยืนยันโดยเจ้าของ):** `net = s + h` ("ต่อ" บวกเข้า net ตาม prototype `golf-team-mode.jsx`)
> เดิมเอกสารตีความว่าเป็นบั๊กให้เปลี่ยนเป็นลบ — กลับมาเป็น **บวก** ตามกติกาจริง

**ตัวอย่าง:** par 5, ตีจริง 7, handicap[5] = 2 → net = 7 + 2 = **9**
